...
[가장 긴 증가하는 부분 수열 2](https://www.acmicpc.net/problem/12015) - nums[i] 이상인 최솟값과 nums[i]와 바꾸기

[놀이 공원](https://www.acmicpc.net/problem/1561) - 이분탐색 + 그리디

[기타 레슨](https://www.acmicpc.net/problem/2343) - 합 + 최솟값 찾기
