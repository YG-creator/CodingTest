...
str.charCodeAt('a'); *// 97     -> 'a'에 해당하는 UTF-16 코드를 반환함.*
...
// 특수 문자 나누기
String str = "asdf.wer"
String[] = str.split("\\특수문자"); // 정규식에 .과 +를 사용해서 .과 + 는 앞에 \\ 붙여야 됨


// 여러 특수문자로 나누기
String[] = str.split("문자|문자");	// | 사용
```
...
[크로아티아 알파벳](https://www.acmicpc.net/problem/2941) - 문자갯수세기(알파벳 + 크로티아)
