...
* https://www.acmicpc.net/problem/1920
  ...
  값존재 완전탐색하면 시간초과네? -> HashMap(숫자 : idx) 사용하자

* https://www.acmicpc.net/problem/4195 v

  노드간 연결 확인 필요 -> Union find ->  Union-find 사용할려면 idx가 필요한데 String만 주어졌네? -> HashMap으로 str : idx
...
* https://www.acmicpc.net/problem/1233
  ...
  모든 조합 만들기 -> 합 구하기 -> map에 넣기(합 : 갯수) -> 갯수 최대, key값 최소인거 찾기
...
* https://www.acmicpc.net/problem/2812 : 왼큰수
  ...
  왼쪽수 기준으로하면 비교하면 완전탐색 -> 시간초과 -> 오른쪽수 기준으로 비교하면 LIFO -> 오큰수 아니면 stack에 추가 / 오큰수면 pop() 후 다시 비교 -> ㅑidx출력을 위해 stack에 num,idx 넣기 

  ``` 
  1. for i in range(1,n)
  	1. 왼쪽 수 >= 오른쪽수 전까지 반복
  		1. 왼쪽수 idx = stack[-1], 오른쪽수 idx = i
  		2. stack.pop(), ans[왼쪽수 idx] = 오른쪽수 
  	2. stack에 i 넣기
  ```
...
* https://www.acmicpc.net/problem/2110 vv
